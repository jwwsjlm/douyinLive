...
func NewDouyinLiveWithTikHub(liveID string, logger logger, cookie string, tikHubToken string) (*DouyinLive, error) {
	return newDouyinLive(liveID, logger, cookie, tikHubToken)
}

func newDouyinLive(liveID string, baseLogger logger, cookie string, tikHubToken string) (*DouyinLive, error) {
...
func (dl *DouyinLive) generateTikHubXBSignature(roomID, userUniqueID string) (string, error) {
